                  ...
                  <div class="card-body p-md-3 mx-md-3">
                    ...
                    <form>
                      ...
                      <div class="text-center pt-1 mb-2">
                        <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block gradient-custom-2 mb-3" type="button" @click="idiNaHome">Prijava</button>
                      </div>
                      <div class="d-flex align-items-center justify-content-center pb-4">
                        <p class="mb-0 me-2" style="font-size: medium; opacity: 0.8;">Nemate korisnički račun?</p>
                        <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger" @click="idiNaSign">Registriraj se</button>
                      </div>
                    </form>
                  </div>
                </div>
